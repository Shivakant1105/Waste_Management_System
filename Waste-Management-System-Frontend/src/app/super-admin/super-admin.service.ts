...
export class SuperAdminService {
  ...
  getAllAdmins() {
    this.http
      .get<{ message: string; dataOfAdmins: Admin[] }>(
        this.backendLink + "/api/admin/getAdmins"
      )
  ...
  addAdmin(data: any) {
    this.http
      .post(this.backendLink + "/api/admin/addadmin", data)
      .subscribe((res) => {
        console.log(res);
      });
  }
  ...
  deleteRegionBySuperAdmin(regionalAdminCnic: string) {
    this.http
      .delete(
        this.backendLink + "/api/admin/delete-region/" + regionalAdminCnic
      )
      .subscribe((data) => {
        console.log(data);
      });
