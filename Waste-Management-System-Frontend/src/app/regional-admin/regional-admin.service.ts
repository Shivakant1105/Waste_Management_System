...
export class RegionalAdminService {
  ...
  getRegionAdminDetails(regionCode: string) {
    this.http
      .get<{ message: string; adminDetails: Admin }>(
        this.backendLink + "/api/admin/getAdminDetails/" + regionCode
      )
      .subscribe((response) => {
  ...
  getAllDustbinsByRegion(regionCode: string) {
    this.http
      .get<{ message: string; dustbins: Dustbin[] }>(
        this.backendLink + "/api/dustbin/" + regionCode
      )
  ...
  getDriversByRegion(region: string) {
    this.http
      .get<{ message: string; driversData: Driver[] }>(
        this.backendLink + "/api/driver/get-driver-by-region/" + region
      )
      .subscribe((response) => {
  ...
  addDustbin(region: string, data: any) {
    this.http
      .post(this.backendLink + "/api/dustbin/add/" + region, data)
      .subscribe((response) => {
  ...
  addDriver(data: any) {
    this.http
      .post(this.backendLink + "/api/driver/addDriver", data)
      .subscribe((response) => {
        console.log(response);
      });
  }
  ...
  deleteDriver(email: string) {
    this.http
      .delete(this.backendLink + "/api/driver/delete-driver/" + email)
      .subscribe((resp) => {
        console.log(resp);
      });
  }
  ...
  toggleDriverRouteAssigned(email: { emailId: string }) {
    this.http
      .put<{ message: string }>(
        this.backendLink + "/api/driver/toggle-route-assigned",
        email
      )
      .subscribe((response) => {
